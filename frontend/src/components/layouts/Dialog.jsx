...
export function ExitWarningDialog({
  ...
  description = "You haven't finished your quiz yet. Press Stay to continue, or Leave if you're sure.",
  cancelText = 'Stay',
  confirmText = 'Leave',
  confirmBgColor = 'bg-[#151313]',
}) {
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="bg-[#f7f7f5] border-2 border-[#151313] rounded-2xl shadow-[8px_8px_0px_#151313] p-6">
        ...
        <AlertDialogFooter className="gap-2">
          ...
          <AlertDialogAction
            onClick={onConfirm}
            className={`${confirmBgColor} text-white border-2 border-[#151313] rounded-xl px-4 py-2 text-xs font-black shadow-[2px_2px_0px_#151313] hover:bg-[#333] transition-all`}
          >
            {confirmText}
          </AlertDialogAction>
        </AlertDialogFooter>
